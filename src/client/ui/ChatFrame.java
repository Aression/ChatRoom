...
public class ChatFrame extends JFrame{
    ...
    public void init(){
        ...
        this.setTitle("myChatRoom: " + DataBuffer.currentUser.getNickname());
        ...
        otherInfoLbl = new JLabel("当前状态：全频聊天...");
...
//        btnPanel.add(shakeBtn);
        ...
        rybqBtn.setToolTipText("与所选用户私聊");
        ...
        closeBtn.setToolTipText("退出聊天室");
        btn2Panel.add(closeBtn);
        JButton submitBtn = new JButton("发送(Enter)");
        submitBtn.setToolTipText("发送消息");
            ...
            public void actionPerformed(ActionEvent e) {
                if(rybqBtn.isSelected()){
                    ...
                    if(null == selectedUser){
                        ...
                        otherInfoLbl.setText("当前状态：不允许与自己私聊");
                    }else{
                        otherInfoLbl.setText("当前状态：与用户 "+ selectedUser.getNickname()
